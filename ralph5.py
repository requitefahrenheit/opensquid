...
Changes:
  ...
  2. Worker prompt: "You are the mathematician. Construct proofs. Never ask."
  3. Evaluator prompt: Three signals only -- COMMIT, REFRAME, SEARCH
  4. Thread C stays Haiku (compression is mechanical)
...
Output files:
  session_*_briefing.md     -- Plain-language summary
